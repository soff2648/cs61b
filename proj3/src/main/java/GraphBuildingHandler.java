...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private long currentNameID;
    private long lastWayNode;
    private boolean wayValid;
    private List<Long> wayVertices;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            wayVertices = new LinkedList<>();
        } else if (activeState.equals("way") && qName.equals("nd")) {
            /* While looking at a way, we found a <nd...> tag. */
            //System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            long vertex = Long.parseLong(attributes.getValue("ref"));
            ...
            g.addName(currentNameID, attributes.getValue("v"));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            //System.out.println(wayValid);

            if (wayValid) {
                for (int i = 1; i < wayVertices.size(); i++) {
                    g.addEdge(wayVertices.get(i - 1), wayVertices.get(i));
                }
                //System.out.println("Update the way");
            }
